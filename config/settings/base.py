...
LOGGING = {
    ...
    "formatters": {
        ...
        "celery_json": {
            "()": "app.core.logging.JsonCeleryFormatter",
            "datefmt": "%Y-%m-%dT%H:%M:%SZ",
            "format": (
        ...
        "celery_task_json": {
            "()": "app.core.logging.JsonCeleryTaskFormatter",
            "datefmt": "%Y-%m-%dT%H:%M:%SZ",
            "format": (
                "%(asctime)s %(levelname)s %(celeryTaskId)s %(celeryTaskName)s "
                "%(message)s "
...
# https://docs.celeryq.dev/en/master/django/first-steps-with-django.html#django-celery-results
